...
// CODE HERE
var myFriends = ["none", " of", " your", " beeswax"];
/**
 * #6
 *
...
function evensOnly() {
  ...
  for(var i=0; i<myNumbers.length;i++){
	  if(myNumbers[i]%2===0)arr.push(myNumbers[i]);
  }
  return arr;
}
...
var indexes=[];
function indexFinder(arr, newArray){
